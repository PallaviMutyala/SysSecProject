...
public final class Taint {
    ...
    //XXX: CSE 509 Adding sink points
    /**
     * @hide
     */
    ...
    public static int TAINT_REMOVE;
    // how many bytes of tainted network output data to print to log?
    public static final int dataBytesToLog = 100;

    public static int getTaintRemove()
    {
	    return TAINT_REMOVE;
    }

    public static void setTaintRemove(int flag)
    {
	    TAINT_REMOVE = flag;
    }
     ...
     * @hide
     */
    native public static void removeTaintString(String s, int source, int sink);
   
    /**
     * @hide
     */
   native public static double RemoveTaintDouble(double d, int source, int sink);
    /**
     * @hide
     */
}
